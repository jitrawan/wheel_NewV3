                                           ...
                                           <label for="width">ความกว้าง</label>
                                            ...
                                            <div class="form-group row">
                                              <div class="col-md-4 pr-2">
                                                 ...
                                                 <input type="text" name="groudRubber" id="groudRubber" class="form-control cb" value="" required>
                                              </div>
                                              <div class="col-md-3 pr-2 pl-2">
                                                <label for="code">สัปดาห์ที่ผลิต</label>
                                                <input type="number" name="productionWeek" id="productionWeek" class="form-control cb" value="" required>
                                             </div>
                                            ...
                                            <div class="form-group row">
                                              <div class="col-md-4 pr-2">
                                                 ...
                                                 <input type="number" name="speedIndex" id="speedIndex" class="form-control cb" value="" required>
                                              </div>
                                              <div class="col-md-4 pr-2 pl-2">
                                                <label for="code">ดัชนีรับน้ำหนัก</label>
                                                <input type="number" name="weightIndex" id="weightIndex" class="form-control cb" value="" required>
                                             </div>
                                             </div>
                                         </div>
