...
if(mysql_num_rows($getShelf) < 1){
        $getdata->my_sql_insert_New("shelf","shelf_code, shelf_detail, shelf_class, amt , shelf_status  ","'".addslashes($_POST['shelf_code'])."' ,'".addslashes($_POST['shelf_detail'])."' , '".addslashes($_POST['shelf_class'])."'  , '".addslashes($_POST['shelf_amt'])."'  ,'".addslashes($_POST['shelf_status'])."' ");
