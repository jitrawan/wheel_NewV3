...
if(isset($_POST['save_card'])){
    ...
    $getShelf = $getdata->my_sql_select(NULL,"shelf","shelf_code = '".addslashes($_POST['shelf_code'])."' and shelf_detail ='".addslashes($_POST['shelf_detail'])."' and shelf_class = '".addslashes($_POST['shelf_class'])."' and amt = ".$_POST['shelf_amt']."  ");
                                        ...
                                        <div class="modal-body">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                              ...
                                              <input type="number" name="shelf_class" id="shelf_class" class="form-control number" require>
                                            </div>
                                          </div>
