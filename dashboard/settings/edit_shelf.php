 ...
 <div class="modal-body">
	 <div class="form-group row">
		 <div class="col-md-6">
			 ...
			 <input type="text" name="edit_shelf_detail" id="edit_shelf_detail" class="form-control" value="<?php echo @$getctype_detail->shelf_detail;?>" autofocus require>
		 </div>
		 <div class="col-md-6">
			 <label for="edit_shelf_detail">ชั้น สินค้า</label>
			 <input type="number" name="edit_shelf_class" id="edit_shelf_class" class="form-control number" value="<?php echo @$getctype_detail->shelf_class;?>" require>
		 </div>
	 </div>
